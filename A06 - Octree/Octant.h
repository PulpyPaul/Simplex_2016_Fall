...
namespace Simplex
{
	...
	class Octant
	{
		...
		static uint m_uLeafCount; // will store the number of leafs
		...
		uint m_uEntityCount; // hold the current amount of entities in the octant
		...
		vector3 m_v3Size = vector3(0.0f); // will store the size of the octant
	...
	public:
		...
		*/
		...
		/*
		USAGE: Creates the Entity Dimensions for each leaf
		ARGUEMENTS: ---
		OUTPUT: ---
		*/
		void CreateLeafDimensions(void);
